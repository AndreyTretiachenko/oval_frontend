      ...
      <tbody>
        <tr class="row0">
          ...
          <td class="column1 style141 s style143" colspan="7">
            Заказ-наряд: 465/1 от 30 ноября 2022(Акт выполненных работ)
          </td>
        ...
        <tr class="row48">
          ...
          <td class="column1 style88 s style88" colspan="10" rowspan="3">
            ...
            обязан предъявить исполнителю непосредственно при получении его из
            тех. обслуживания и ремонта. В противном случае он теряет право
            впоследствии ссылаться на эти недостатки. Заказчик обязан с участием
            Подрядчика осмотреть и принять транспортное средство после
